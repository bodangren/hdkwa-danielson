...
- [ ] Task: Confirm the basePath omission in build output
...
- [ ] Task: Create a basePath-aware image path helper
...
- [ ] Task: Update strategy detail page to use the helper
...
- [ ] Task: Audit and fix any other public asset references
...
- [ ] Task: Run production build and verify fix
  - [ ] Run `NODE_ENV=production npm run build`
